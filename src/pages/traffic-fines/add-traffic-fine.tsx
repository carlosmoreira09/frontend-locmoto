            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <CardContent className="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <div className="space-y-2 col-span-full">
                        ...
                        {errors.violationObs && <span className="text-red-500 text-sm">{errors.violationObs.message}</span>}
                    </div>
                    ...
                    <div className="space-y-2 col-span-full">
                        ...
                        <Input id="violationAddress" {...register("violationAddress", { required: "Campo obrigatório" })} />
                        {errors.violationAddress && <span className="text-red-500 text-sm">{errors.violationAddress.message}</span>}
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="uf" {...register("uf", { required: "Campo obrigatório", maxLength: 2 })} maxLength={2} />
